					...
					<div class="col-sm-12">
                         <table align="center" border=0px bgcolor=#E3DAC9 >
                            <tr style="color:blue;">
                                                ...
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center" width="250px"><b>Comida</b></td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center"width="50px"><b>Cantidad</b></td>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center"><b>Hora</b></td>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center" width="150px"><b>Estatus</b></td>
												<td></td>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<a href="formPedidoU.php" class="btn btn-success">Nuevo pedido</a><br/><br/><br/>
							</div>
						</div>
